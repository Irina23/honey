<?php
/**------------------------------------------------------------------------
; plg_soccomments - Social Comments Plugin Content for Joomla 3.x
; author    tallib
...
; -------------------------------------------------------------------------------------------
/**------------------------------------------------------------------------
* file: soccomments.php 1.3.0, October 2013 14:00:00 tallib $
...
<a href="http://disqus.com" class="dsq-brlink" rel="nofollow">blog comments powered by <span class="logo-disqus">Disqus</span></a>';
			...
			$html .= '<div class="'.$cpr.'"><a href="http://futuresbroker.ru/soccom/soccomments-v13.htm" title="Download SocComments v1.3" target="_blank">Download SocComments v1.3</a></div>';
